body <- bs4DashBody(
  ...
  bs4TabItems(
    ...
    bs4TabItem(
      ...
      fluidRow(
        bs4Card(
          title = tagList(shiny::icon("calendar"), "Infos"), 
          width = 12, 
          elevation = 4,
          collapsible = TRUE, 
          solidHeader = TRUE,
          p("This simple application aims at solving the Lorenz Model 
          for different initial conditions. You can change the integration 
          time or time step by playing with sliders. Moreover, you can control the
