    ...
    tabPanel("Change parameters", 
      ...
      # Show a plot of the generated distribution
        tabsetPanel(
          ...
          tabPanel(id="tabPanel2", "Main Results",
                   dashboardPage(skin = "black",
                                 ...
                                 dashboardBody(
                                   fluidRow(
                                     box(
                                       title = "Phase Plane Graphs", width = 4, solidHeader = TRUE, 
                                       status = "primary", collapsible = TRUE,
                                       conditionalPanel("go",
                                   ...
                                   fluidRow(
                                     box(
                                       width = 4, background = "black",
                                       inputPanel(id ="input1", style="height: 40vh; overflow-y: auto; 
                                     ...
                                     box(
                                       title = "Initial Values", width = 4, background = "light-blue",
                                       inputPanel(style="height: 40vh; overflow-y: auto; 
                                                  max-height: 340px", # vertical scrolling
                                     ...
                                     box(
                                       title = "Tools",width = 4, background = "maroon",
                                       inputPanel(style="height: 15vh; overflow-y: auto;", # vertical scrolling
                                                  column(width = 4,
                                                  actionButton(class="fa fa-refresh fa-5x",inputId="go", label=" Update", class="btn btn-success"),
          ...
          tabPanel(id="tabPanel3", "Secondary Results"
          ),
          tabPanel(id="tabPanel4" ,"Test",
                   dashboardPage(skin = "black",
                     dashboardHeader(disable = TRUE),
                     dashboardSidebar(disable = TRUE),
                     dashboardBody(
