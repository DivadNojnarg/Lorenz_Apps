body <- dashboardBody(
  ...
  tabItems(
    ...
    tabItem(
      ...
      fluidRow(
        box(
          title = tagList(shiny::icon("info"), "Infos"), width = 6, collapsible = T, solidHeader = TRUE,
        ...
        box(
          title = tagList(shiny::icon("superscript"), "Steady/States"), width = 6, collapsible = T, solidHeader = TRUE,
