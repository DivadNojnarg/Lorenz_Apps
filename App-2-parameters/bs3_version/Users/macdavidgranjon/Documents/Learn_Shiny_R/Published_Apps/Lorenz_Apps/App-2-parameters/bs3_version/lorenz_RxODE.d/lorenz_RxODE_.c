...
extern void lorenz_RxODE__ode_solver(int *neq,
  ...
  //if (_ptrid() != 1536653554 ){ _assign_ptr(lorenz_RxODE__model_vars());}
  double *_theta = theta;
...
extern SEXP lorenz_RxODE__model_vars(){
  ...
  if (!_rxIsCurrentC(_mv)){
    ...
    SET_STRING_ELT(mmd5,0,mkChar("8661d5228efd41399df0690237c0f35d"));
    SET_STRING_ELT(mmd5n,1,mkChar("parsed_md5"));
    SET_STRING_ELT(mmd5,1,mkChar("6eff0ed9db8888554d78ae7c817a60e8"));
